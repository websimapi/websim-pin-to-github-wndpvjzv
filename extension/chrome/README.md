...
When auto-sync is enabled, opening one of your own unlinked Websim projects bootstraps its first revision once; later commits are driven by pin or version changes. The extension verifies that the signed-in Websim account matches the project's creator before it can create or write a GitHub repository.
